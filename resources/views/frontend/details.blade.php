					...
					<div class="col-12">
						<div class="header__content">
							...
							<ul class="header__nav">
								...
								<!-- dropdown -->
								<li class="header__nav-item">
                                    <a class="dropdown-toggle header__nav-link" href="/catalog">CATALOG</a>
                                </li>
								<!-- end dropdown -->

								<!-- dropdown -->
                                <li class="header__nav-item">
                                    <a class="dropdown-toggle header__nav-link" href="/about">ABOUT</a>
                                </li>
								<!-- end dropdown -->
							</ul>
							<!-- end header nav -->	
										...
										<ul class="comments__list">
											<li class="comments__item">
												<div class="comments__autor">
													<img class="comments__avatar" src="{{ asset('assets/frontend/img/user.png')}}" alt="">
										...
										<ul class="reviews__list">
											<li class="reviews__item">
												<div class="reviews__autor">
													<img class="reviews__avatar" src="{{ asset('assets/frontend/img/user.png')}}" alt="">
							...
							<div class="gallery" itemscope>
								<div class="row">
									...
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{ asset('assets/frontend/img/gallery/project-1.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{ asset('assets/frontend/img/gallery/project-1.jpg')}}" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{ asset('assets/frontend/img/gallery/project-2.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{ asset('assets/frontend/img/gallery/project-2.jpg')}}" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{ asset('assets/frontend/img/gallery/project-3.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{ asset('assets/frontend/img/gallery/project-3.jpg')}}" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{ asset('assets/frontend/img/gallery/project-4.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{ asset('assets/frontend/img/gallery/project-4.jpg')}}" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{ asset('assets/frontend/img/gallery/project-5.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{ asset('assets/frontend/img/gallery/project-5.jpg')}}" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{ asset('assets/frontend/img/gallery/project-6.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{ asset('assets/frontend/img/gallery/project-6.jpg')}}" itemprop="thumbnail" alt="Image description" />
										</a>
				...
				<div class="col-12 col-lg-4 col-xl-4">
					<div class="row">
						...
						<div class="col-6 col-sm-4 col-lg-6">
							<div class="card">
								<div class="card__cover">
									<img src="{{ asset('assets/frontend/img/covers/cover5.jpg')}}" alt="">
									<a href="#" class="card__play">
										<i class="icon ion-ios-play"></i>
									</a>
								</div>
						...
						<div class="col-6 col-sm-4 col-lg-6">
							<div class="card">
								<div class="card__cover">
									<img src="{{ asset('assets/frontend/img/covers/cover6.jpg')}}" alt="">
									<a href="#" class="card__play">
										<i class="icon ion-ios-play"></i>
									</a>
								</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-3">
					...
					<ul class="footer__app">
						<li><a href="#"><img src="{{ asset('assets/frontend/img/Download_on_the_App_Store_Badge.svg')}}" alt=""></a></li>
						<li><a href="#"><img src="{{ asset('assets/frontend/img/google-play-badge.png')}}" alt=""></a></li>
					</ul>
				</div>
				<!-- end footer list -->
