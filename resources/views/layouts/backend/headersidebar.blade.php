					...
					<ul class="nav metismenu">
						<li class="nav-dropdown active">
							...
							<ul class="collapse nav-sub" aria-expanded="true">
								<li class="active"><a href="/admin"><span>Default</span></a></li>
								<li><a href="/admin/artikel"><span>Artikel</span></a></li>
								<li><a href="/admin/tag"><span>Tag</span></a></li>
								<li><a href="/admin/kategori"><span>Kategori</span></a></li>
							</ul>
						</li>
					</nav>
				</div>
					...
					<ul class="navbar-nav nav-right">
						<li class="nav-item dropdown">
							<a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
								<img src="/assets/backend/assets/img/avatars/1.jpg" class="w-35 rounded-circle" alt="Albert Einstein">
							</a>
